...
class _ShippingAddressState extends State<ShippingAddress> {
  ...
  getuser() async {
    ...
    setState(() {
      this.user = user;
      this.house.text = json.decode(user)['shipping_address']['house'];
      this.street.text = json.decode(user)['shipping_address']['street'];
      this.area.text = json.decode(user)['shipping_address']['area'];
      this.city.text = json.decode(user)['shipping_address']['city'];
      this.pincode.text =
          json.decode(user)['shipping_address']['pincode'].toString();
  ...
  updateuser() async {
    ...
    final uri = Uri.parse(
        'https://singhpublications.onrender.com/api/user/updateshippingaddress?id=${json.decode(user!)['id']}');
    final headers = {
